					...
					if($print==mobile){include "../php-include_sub/set_desktop.php";}
					elseif($print==screen){include "../php-include_sub/set_mobile.php";}
					else{include "../php-include_sub/set_mobile.php";
					include "../php-include_sub/set_desktop.php";}?>
					<!--	Footer	***SLUTT***	-->
