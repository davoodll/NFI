    ...
    <body>
      <div id="ytterst">
        ...
        <?php
          ...
          $sql="INSERT INTO AndreHenvendelser (navn, adresse, telefon, epost, kontaktform, henvendelse, nyhetsbrev)
          VALUES
          ('$_POST[navn]','$_POST[adresse]','$_POST[telefon]','$_POST[epost]','$kontaktform','$_POST[question]','$_POST[member]')";
